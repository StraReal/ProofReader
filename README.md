...
*equilateral*, which can go after any polygon and makes its sides equal in length. *square* works too, but only for quadrilaters (added for simplicity purposes)
